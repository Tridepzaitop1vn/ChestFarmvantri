...
function AllowRunServiceBind.OnInvoke(args)
    ...
    CoreGui:SetCore("SendNotification", {
        Title = "Chest Farm",
        Text = "by vantri1509 ",
        Icon = "rbxthumb://type=Asset&id=16285097199&w=150&h=150",
        Duration = math.huge,
...
DiscordLib:Notification("Thông Báo" , "Nhân Cay Thuê Ae Nao Cân IB" , 6 ,11816162894 )
	DiscordLib:Notification("Thông Báo" , "Ib 0797791509  c t vn" , 6 ,11816162894 )
